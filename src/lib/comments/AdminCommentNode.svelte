		...
		>
			...
			<div class="flex items-start justify-between gap-2">
				...
				<div class="flex shrink-0 items-center gap-1.5">
					<span
						class="tabular inline-flex items-center gap-0.5 rounded-full bg-emerald-100 px-2 py-0.5 text-xs font-medium text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400"
					>
						<ArrowUp size="12" strokeWidth="2.25" aria-hidden="true" />
						{comment.upvotes}
					</span>
					<span
						class="tabular inline-flex items-center gap-0.5 rounded-full bg-rose-100 px-2 py-0.5 text-xs font-medium text-rose-700 dark:bg-rose-950/40 dark:text-rose-400"
					>
