				...
				<div class="flex items-center space-x-1.5">
					{#if !isDeleted}
						...
						<button
							...
							class="rounded-full p-1.5 transition-[background-color,color,transform] duration-150 ease-out active:scale-[0.96] disabled:cursor-not-allowed disabled:opacity-60
						...
						<button
							...
							class="rounded-full p-1.5 text-neutral-500 transition-[background-color,color,transform] duration-150 ease-out hover:text-neutral-900 active:scale-[0.96] dark:text-neutral-400 dark:hover:text-neutral-100"
						>
						...
						<button
							...
							class="rounded-full p-1.5 text-neutral-500 transition-[background-color,color,transform] duration-150 ease-out hover:text-rose-600 active:scale-[0.96] dark:text-neutral-400 dark:hover:text-rose-400"
						>
