...
<article class="pt-10">
	<!-- Title -->
	<div>
		<h1 class="text-primary-50 text-4xl font-semibold md:text-5xl md:font-semibold">
			{data.meta.title}
		</h1>
	...
	<div class="tags my-1">
		{#each data.meta.categories as category}
			<span class="text-primary-100 surface-4 rounded-lg p-1 transition hover:bg-[#424242]"
				>&num;{category}</span
			>
		{/each}
	</div>
